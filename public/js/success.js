...
btn.addEventListener('click', () => {
    // let cartCounter = document.querySelector('.cart-item-count');updateNavCartCounter();
...
//         <li class="link-item navBlock2"><a href="/" class="link active">home</a></li>
//         <li class="link-item"><a href="/" class="link active">
//         <div class="cart navBlock" onclick="location.href = '/cart'">
//         <img src="../img/home.png" class="cart-icon" alt="">
//         </div>
//         </a></li>
//         <li class="link-item navBlock2"><a href="/dashboard" class="link">your product</a></li>

//         <li class="link-item"><a href="/dashboard" class="link">
//         <div class="cart navBlock navBlockDiv" onclick="location.href = '/cart'">
//         Sell
