...
// const stripe = require('stripe')('sk_test_51Lw6mISGhL1IKQDnmx9CH4mZv7wGcEfaT8np8Bbrwm6mFdw3OcaW5Nk8p8HhzUj0Z0OLxA65qrYUTylvB8nO8ITg00fwOCsUw5');


// Your web app's Firebase configuration
const firebaseConfig = {
  apiKey: "AIzaSyDvrJtWPnCt1RdIBBPFoOpb4vmSMlnOv98",
  authDomain: "ecom-website-84b74.firebaseapp.com",
  projectId: "ecom-website-84b74",
  storageBucket: "ecom-website-84b74.appspot.com",
  messagingSenderId: "761002700788",
  appId: "1:761002700788:web:e5982d109c74d6581713a1",
};
...
// const AWS_SECRET_KEY = "AKIA2C42BTCJQHYP2NSS";
// const AWS_ACCESS_KEY = "AKIA2C42BTCJUNILHTEZ";

// aws setup
const region = "ap-south-1";
const bucketName = "ecom-website-x1";
...
app.post("/add-product", (req, res) => {
  ...
  if (!draft) {
    if (!name.length) {
      ...
      res.json({ alert: "short des must be added" });
